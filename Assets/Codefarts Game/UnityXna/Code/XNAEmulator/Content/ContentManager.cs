    ...
    public class ContentManager
    {
        ...
        private SpriteFont LoadSpriteFont(string asset)
        {
                ...
                && fontSettings.ContainsKey("Style"))
            {
                ...
                if (fontSettings.ContainsKey("UseKerning"))
                {
                    useKerning = bool.Parse(fontSettings["UseKerning"]);
                }

                var spriteFont = new SpriteFont(fontSettings["FontName"], float.Parse(fontSettings["Size"]), float.Parse(fontSettings["Spacing"]), useKerning, fontSettings["Style"]);
